...
class NewsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('news')->insert([
            [
                'id' => 1,
                'preview_image' => 'http://127.0.0.1:8000/uploads/media_655fc074dab17.jpg',
        ...
        DB::table('news')->insert([
            [
                'id' => 2,
                'preview_image' => 'uploads/media_655fbe403efd4.jpg',
        ...
        DB::table('news')->insert([
            [
                'id' => 3,
                'preview_image' => 'http://127.0.0.1:8000/uploads/media_655fbf03db2b3.jpg',
        ...
        DB::table('news')->insert([
            [
                'id' => 4,
                'preview_image' => 'http://127.0.0.1:8000/uploads/media_655fbf6fb1804.jpg',
