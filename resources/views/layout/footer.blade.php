    ...
    <div class="container">
        <div class="site-footer__middle">
            <div class="row">
                ...
                {{-- Left side  --}}
                <div class="col-xl-9 col-lg-9 col-md-12 wow fadeInUp">
                    <div class="row">

                        <div class="col-md-4">
                            <div class="footer-widget__column footer-widget__link text-center">
                                <div class="footer-widget__title-box">
                                    <h3 class="footer-widget__title">حول</h3>
                                </div>
                                <ul class="footer-widget__link-list list-unstyled">
                                    <li><a href="team.html">الأعضاء</a></li>
                                    <li><a href="events.html">نبذة عن البلدية</a></li>
                                    <li><a href="/presidant">كلمة الرئيس</a></li>
                                </ul>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="footer-widget__column footer-widget__explore text-center">
                                <div class="footer-widget__title-box">
                                    <h3 class="footer-widget__title">المركز الإعلامي</h3>
                                </div>
                                <ul class="footer-widget__link-list list-unstyled">
                        ...
                        <div class="col-md-4">
                            <div class="footer-widget__column footer-widget__Contact text-center">
                                <div class="footer-widget__title-box">
                                    <h3 class="footer-widget__title">اتصل بنا</h3>
                                </div>
                                <p class="footer-widget__Contact-text">اربد - الرمثا</p>
